...
import com.vsi.controller.ReturnAckController;
...
public class ReturnAckMain {
    ...
    public void test() {
        try {
            ...
            ReturnAckController controller = new ReturnAckController();
            controller.initiateReturnAck(prop, driver);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
